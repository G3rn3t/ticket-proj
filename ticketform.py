...
def enter_data():
    ...
    if accepted == "Accepted":
        ...
        if firstname and lastname:
            ...
            workbook.save(filepath)
            tkinter.messagebox.showinfo(title="Data Validated!", message="Data Submitted, Thank you!")
...
title_combobox = ttk.Combobox(user_info_frame, values=["Mr.", "Miss", "Dr."])
...
nationality_combobox = ttk.Combobox(user_info_frame, values=["American", "British"])
...
button.grid(row=3, column=0, stick="news", padx=200, pady=10)
window.mainloop()
